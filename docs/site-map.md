...
- Headline (built, draft copy): the h1 itself rolls — one driver slogan at a time, swapping to the next every few seconds like an odometer, starting on "Where you're known by your name, not your truck number." Each slogan keeps the headline's two-tone: the setup in black over its turn in grey, on two lines from tablet up. The fixed "Freight that moves. A team that drives it." headline was removed on 2026-09-17 so the slogans could take its place. The first thing on the page, directly under the nav
- Apply cards (built, draft copy): three flat cards — Driver, Dispatcher, Tire shop — each a photo, the role and one line, under "Where you'd fit. / Five questions for any of them, then HR calls you back." The whole card is the link. Replaced the full-width photo band on 2026-09-17. All three photos are the owner's: a driver standing in front of his truck, a dispatcher at his screens, and the tire shop. The truck photo that used to fill the band (`home-hero-desert.jpg`) briefly became the driver card and was then replaced by the driver portrait the same day — it is no longer used anywhere. The intro plays over the top of the page and fades away to reveal them; repeat views show them straight away. Dispatcher and Tire shop both land on `/careers/staff`, which doesn't yet separate the two. The quiet "Five questions to apply" link under the headline was dropped the same day, since these cards say it three times over
