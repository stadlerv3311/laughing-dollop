...
### 🏠 Homepage — `/`
- Opening (rebuilt 2026-09-23, removing the video intro): the hero video shows straight away, no wait, no white flash. The only thing that still plays is a short logo moment — the header's logo fades in and settles into place over about a second, then the headline lights up right after
- Hero (built 2026-09-18): light split. Left, on white, set low: the fixed h1 "Where you're known by your name, not your truck number.", one line under it (draft), Apply to drive (dark button) and Get a quote (link). Right: our truck on a mountain highway through pine forest at dawn, full height. The site header sits over it unchanged. Below 1280px the photo goes on top and the words below it
...
- Apply cards (built, draft copy): three flat cards — Driver, Dispatcher, Tire shop — each a photo, the role and one line, under "Where you'd fit. / Five questions for any of them, then HR calls you back." The whole card is the link. Replaced the full-width photo band on 2026-09-17. All three photos are the owner's, and all three are people: a driver standing in front of his truck, a dispatcher at his screens, and a tire tech in the shop. The truck photo that used to fill the band (`home-hero-desert.jpg`) briefly became the driver card and was then replaced by the driver portrait the same day — it is no longer used anywhere. Dispatcher and Tire shop both land on `/careers/staff`, which doesn't yet separate the two. The quiet "Five questions to apply" link under the headline was dropped the same day, since these cards say it three times over
- Ship with us (built, draft copy): the shipper band — label, "Dry van truckload, handled with care.", a line on what to send us, a line on the equipment (nearly all new: 2025–2026 Volvo trucks, brand-new 2025–2026 trailers — added 2026-09-21; the years need updating as the fleet turns over), and the Get a Quote button, with the Sierra mountain-highway photo on the left (swapped with the hero's front-quarter truck 2026-09-21). From `lg` the photo lifts into the left half and runs to the screen edge with an angled right edge; below that it stacks as a plain full-width band. On first scroll into view the photo slides in from off the left edge and the text from the right, landing together (2026-09-18). Replaced the light/dark "Ship with us" / "Drive for us" split on 2026-09-18 — the apply cards above now carry all the recruiting, so the dark half was asking the driver a third time
- Trust bar (built): 32M+ miles driven · 125,000+ loads completed · 48 states — numbers fill up on scroll. "10+ years in business" was dropped from it 2026-09-21 once the hero carried it. DOT/MC # to add once the numbers are supplied. Sits straight under the hero, above Ship with us (moved 2026-09-21) — hairlines above and below, no background change (2026-09-18)
- Safety band (built, draft copy): "Safety and equipment" — how the freight is looked after: GPS on every truck and trailer, road-facing dash cameras, and every repair and inspection logged. No vendor names on the page (owner, 2026-09-18). Ship with us mirrored: the heading and a three-line list on the left, the side-on logo truck photo on the right, on white. Slides in mirrored: text from the left, photo from the right edge. Hovering, focusing or tapping a row swaps the photo for that row's clip, and leaving the list brings the photo back (2026-09-19). All three clips are placeholders; the GPS one is Samsara's and must be replaced before launch
